...
<body
    ...
    <a href="/secret-admin" style="color:white">Admin-panel</a>
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">With so many options available to you,<br />
                    we suggest you start with the following:</p>
